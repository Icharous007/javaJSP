...
<ul
	...
	<a
		...
		<div class="sidebar-brand-text mx-3">
			${usuarioLogado.login } <%=request.getSession().getAttribute("usuarioLogado") %>>
		</div>
	</a>
	...
	<!-- Nav Item - Dashboard -->
	 <li class="nav-item active"><a class="nav-link" href="<%=request.getContextPath() %>/principal/cadastro.jsp">
