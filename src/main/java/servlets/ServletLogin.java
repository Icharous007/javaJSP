...
public class ServletLogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (login != null && !login.isEmpty() && !login.equalsIgnoreCase("null") && senha != null
					&& !senha.isEmpty() && !senha.equalsIgnoreCase("null")) {

				ModelLogin modelLogin = new ModelLogin();
				modelLogin.setLogin(login);
				modelLogin.setSenha(senha);

				if (daoLoginRepository.autenticacao(modelLogin) != null || modelLogin.getId() != null) {
					...
					request.getSession().setAttribute("isUserAdmin", modelLogin.isUserAdmin());
